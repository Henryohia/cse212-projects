...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns (infinite turns) are not re-enqueued, causing the queue
    //  to end too early and failing the expected sequence. 
    ...
    // Defect(s) Found:  People with negative turns (infinite turns) are not re-enqueued, causing them to disappear from the queue instead of remaining indefinitely.
